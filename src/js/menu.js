const aux = {
  tabContainer: () => {
    return Object.assign(document.createElement('div'), {id: 'tabContainer'})
  },
  getMainContainer: () => {
  ...
  appendImgMarkup: (parent, id) => {
    if (id === 'right') {
      ...
      const img = Object.assign(document.createElement('img'), {src: '../src/img/slices/sobhan-joodi.jpg'}, {id: 'img_container'});
...
const menu = {
  ...
  products: [
    ...
    },
    {
      ...
      description: 'Salmon and vegetables perfect aligned over soy oil and vegetables.',
  ...
  populateMenu: () => {
    ...
    menu.products.forEach(product => {
      ...
      cell.addEventListener('mouseover', () => {
        Object.assign(document.getElementById('img_container'), {src: product.img_path});
      });
